...
class AppDependencies {
  ...
  factory AppDependencies.create() {
    ...
    final organizationRepository = OrganizationRepositoryImpl(organizationDataSource);
    final organizationController = OrganizationController(
      ...
      updateEmployeeDepartment: UpdateEmployeeDepartment(organizationRepository),
      updateEmployeeStatus: UpdateEmployeeStatus(organizationRepository),
    );

    // Dashboard Dependencies
    final dashboardDataSource = DashboardMockDataSource();
    final dashboardRepository = DashboardRepositoryImpl(dataSource: dashboardDataSource);
    final dashboardController = DashboardController(
